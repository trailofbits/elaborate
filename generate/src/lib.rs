...
pub const COMMIT: &str = "b90dc1e597db0bbc0cab0eccb39747b1a9d7e607";
...
static GENERIC_STRUCTS: LazyLock<Vec<Vec<Token>>> = LazyLock::new(|| {
    const INNER: &[(&[&str], &str)] = &[
        ...
        (&["std", "sync", "nonpoison"], "MappedRwLockReadGuard"),
        (&["std", "sync", "nonpoison"], "MappedRwLockWriteGuard"),
        (&["std", "sync", "nonpoison"], "Mutex"),
        (&["std", "sync", "nonpoison"], "MutexGuard"),
        (&["std", "sync", "nonpoison"], "RwLock"),
        (&["std", "sync", "nonpoison"], "RwLockReadGuard"),
        (&["std", "sync", "nonpoison"], "RwLockWriteGuard"),
        (&["std", "sync", "oneshot"], "Receiver"),
        (&["std", "sync", "oneshot"], "Sender"),
